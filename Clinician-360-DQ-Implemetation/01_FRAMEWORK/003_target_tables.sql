...
create or replace TABLE P360_DQ.RAW_INGESTION.RAW_NPI_REGISTRY (
...
create or replace table P360_DQ.BRONZE.STG_NPI_REGISTRY (
	NPI_SK NUMBER(38,0) autoincrement start 1 increment 1 noorder,
	NPI_NUMBER VARCHAR(10),
	PROVIDER_FIRST_NAME VARCHAR(100),
	PROVIDER_LAST_NAME VARCHAR(100),
	PROVIDER_NAME VARCHAR(200),
	...
	JOB_ID VARCHAR(36),
	_SOURCE_LOADED_AT TIMESTAMP_NTZ(9),
	_RUN_ID VARCHAR(36),
	ADDRESS_LINE_1 VARCHAR(200),
	CITY VARCHAR(100),
	PROVIDER_TIN VARCHAR(11)
...
create or replace TABLE P360_DQ.SILVER.SCD2_PROVIDER_ATTRIBUTES (
	SCD_KEY VARCHAR(64) NOT NULL,
	PROVIDER_BK VARCHAR(10),
	PROVIDER_NAME VARCHAR(200),
	CREDENTIAL VARCHAR(50),
	STATE VARCHAR(2),
	...
	_VALID_FROM TIMESTAMP_NTZ(9) NOT NULL,
	_VALID_TO TIMESTAMP_NTZ(9) NOT NULL DEFAULT CAST('9999-12-31' AS TIMESTAMP_NTZ(9)),
...
-- ============================================================
USE SCHEMA RAW_INGESTION;
--select* from RAW_INGESTION.RAW_NPI_REGISTRY 
